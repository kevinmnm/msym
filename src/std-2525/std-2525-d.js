...
function asArray() {
    ...
    const affiliationArray = Object.values(affiliation).sort((a, b) => +a.code - +b.code);
    const symbolsetArray = Object.values(symbolset).sort((a, b) => +a.code - +b.code);
